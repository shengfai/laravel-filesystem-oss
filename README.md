...
## 目录
- laravel >= 9 `composer require "shennfai/laravel-filesystem-oss"`
- laravel < 9 <a href="https://github.com/iiDestiny/laravel-filesystem-oss">iiDestiny/laravel-filesystem-oss</a>
...
```shell
$ composer require "shengfai/laravel-filesystem-oss" -vvv
```
